<?php
	...
	$PINNNO=$_SESSION['PINN_NO'];
		...
		$resulta = $db->prepare("select * from account where ac_account_no='$PINNNO'");
		$resulta->execute();
                ...
                <div class="box-body no-padding">
                	<div class="panel panel-primary">
							...
							<div class="panel-body">                            
                            	...
                            	<!-- Section Start -->
                               	<form method="post" action="profile_accounbtupdate.php" class="forms" autocomplete="off">
                                	<div class="col-md-6 col-sm-12 col-xs-12 well">   
                                        ...
                                        <div class="col-md-6 col-sm-12 col-xs-12">
                                            <label>Age</label>
                                            <input type="number"  name="ac_age" class="form-control" value="<?php echo $ac_age;?>">
                                        </div>  
                                        <div class="col-md-6 col-sm-12 col-xs-12">
                                            <label>Email</label>
                                        ...
                                        <div class="col-md-6 col-sm-12 col-xs-12">
                                            <label>Address</label>
                                           <input type="text" name="addr" class="form-control" value="<?php echo $ac_addr;?>">
                                        </div>                                                                                 
	                                </div>                                    
                                    <div class="col-md-6 col-sm-12 col-xs-12 well">  
                                    	<div class="alert" style="padding:5px; background-color:#3399cc; color:white;">
                                        ...
                                        <div class="col-md-6 col-sm-12 col-xs-12">
                                            <label>Age</label>
                                            <input type="number"  name="n_age" class="form-control" value="<?php echo $n_age;?>">
                                        </div>  
                                        <div class="col-md-6 col-sm-12 col-xs-12">
                                            <label>Email</label>
