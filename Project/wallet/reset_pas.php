                ...
                <div class="box-body no-padding">
                	<div class="panel panel-primary">
							...
							<div class="panel-body">           
                                <form method="get" action="reset_image1.php" class="forms" autocomplete="off">   
                                    ...
                                    <div class="col-md-6 col-sm-12 col-xs-12 well">
                                        ...
                                        <div class="col-md-6 col-sm-12 col-xs-12">
                                            ...
                                            <input list="account_no" placeholder="Search" required class="form-control" name="account_no">
                                            	<datalist id="account_no">
