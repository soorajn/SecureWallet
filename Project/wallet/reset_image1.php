                ...
                <div class="box-body no-padding">
                	<div class="panel panel-primary">
							...
							<div class="panel-body">           
                             	<form method="post" action="save_and_update_delete/reset_password_set_one.php" autocomplete="off" name="form1">
                                    <div class="col-md-6 col-sm-12 col-xs-12 well">                                                                              
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                  		<img src="../photo/<?php echo $photo1;?>" style="width:400px; height:400px;" id="myImgId">
                                            <input type="text" id="x1" name="x1" readonly></input>
