...
<tr>
	<td>
		...
		<h3>Second Coordination</h3>
        	<form method="post" action="user_second_image_password_two.php" autocomplete="off" name="form1">
                <div class="col-md-12 col-sm-12 col-xs-12">
                <img src="photo/<?php echo $photo2;?>" width="400" height="400" id="myImgId">
                	<br>
