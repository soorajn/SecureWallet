<?php
	...
	$result = $db->prepare("select * from walletotp where accountno='$ac_account_no' and stat='approve'");
	$result->execute();
...
<div class="agileits_w3layouts newsletter">
	<div class="container">
		...
		<h3>O T P <span style="color:red;"><?php echo $otp;?></span></h3>
        	<center>              	      
                <form action="user_third_otp_login.php" method="post" autocomplete="off">
                    <input class="text" type="text" name="otp" placeholder="O T P" required="">
