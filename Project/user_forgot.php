<?php
	...
	$ac_email=$_GET["ac_email"];
	$result = $db->prepare("select * from account where ac_email='$ac_email'");
	$result->execute();
...
<div class="agileits_w3layouts newsletter">
	<div class="container">
		...
		<h3>UNIQUE ID<span style="color:red;"> <?php echo $ac_account_no;?></span></h3>        	
		</div>
...
<!-- contact -->
	<div class="contact" id="contact">
		<div class="container">		
			<!--footer-->
			<div class="copy">
		        <p>© 2022 Secure Wallet. All Rights Reserved </p>
		    </div>
			<!--/footer -->
		</div>
	</div>
